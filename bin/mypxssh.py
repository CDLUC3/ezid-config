# Module pxssh from pexpect <http://www.noah.org/wiki/pexpect>, but
# with local modifications marked with (GJ).
...
# (GJ) Following line commented out, as it causes the connection to
# timeout, at least on Mac OS X.
...
# (GJ) Added the -t option below to support sudo'ing.
        ssh_options = '-q -t'
